        ...
        <div className={styles.left}>
          ...
          <div className={styles.travelers}>
            ...
            <div className={styles.selectNumber}>
              ...
              <button className={styles.btn} onClick={() => { number > 0 ? setNumber(number - 1) : setNumber(number) }}>-</button>
        ...
        <div className={styles.right}>
          ...
          <div className={styles.destination}>
            {cart && cart.map((city, i) => <>
              <h3 className={styles.city} key={city.id} onClick={() => delToCart(city.id, i)}>{city.activity}</h3>
              {/* <MdOutlineClose onClick={() => delToCart(city.id)} /> */}
            </>
            )
            }
          </div>
