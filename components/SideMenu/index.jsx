  ...
  return (
    <div className={style.sideWrapper}>
      <div className={isActive ? style.sideMenu : style.hideMenu}>
        ...
        <ul>
          <button
            className={style.ListButtons}
            onClick={() => setActiveDropdown(!isActiveDropdown)}
          >
            Ferdast s world <i className="fa fa-caret-down"></i>
          </button>
          <div
            className={
              isActiveDropdown
                ? style.dropdownContainer
                : style.dropdownContainerActive
            }
          >
            <button
              className={
                isActive ? style.buttonDropdown : style.buttonNotDropdown
              }
            >
              Sicilia
            </button>
